...
const CheckDiamondBody = () => {
  ...
  useEffect(() => {
    if (diamondDetails) {
        navigate(`/diamond-check/${diamondDetails.reportNumber}`, { state: { diamondDetails } });
    }
});
  const diamonds = [
    {
            ...
            >
              ...
              >
                ...
                <Typography color={"#989898"} padding={1}>
                  ...
                  carat and more{" "}
                  <span
                    style={{ color: "#69CEE2", textDecoration: "underline" }}
                  >
                    for free
                  </span>
                </Typography>
        ...
        <Box>
          <Box>
            <Card variant="outlined" sx={{ borderRadius: 0, border: 0 }}>
              ...
              <CardContent>
                <Typography>
                  We understand how important it is for you to have confidence
                  in the quality and value of your diamond purchase. That's why
                  we're here to provide you with comprehensive details about
                  your diamond, ensuring transparency and peace of mind.
                </Typography>
                    ...
                    >
                      ...
                      <CardContent>
                        <Typography>
                          ...
                          authenticity and natural beauty, untouched by
                          synthetic processes.
                        </Typography>
                      </CardContent>
                    </Card>
                  ...
                  <Grid item xl={6} sm={12} md={6}>
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <Typography>
                          ...
                          The source of the diamond, indicating if it is natural
                          or lab-grown.
                        </Typography>
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <Typography>
                          ...
                          The clarity grade of the diamond, ranging from
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                          <span style={{ fontWeight: "bold" }}>Polish:</span>{" "}
                          The quality of the diamond's polish, ranging from Poor
                          to Excellent.
                        </Typography>
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                          <span style={{ fontWeight: "bold" }}>Symmetry:</span>{" "}
                          The quality of the diamond's symmetry, ranging from
                          Poor to Excellent.
                        </Typography>
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                          ...
                          The presence or absence of fluorescence in the
                          diamond.
                        </Typography>
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                ...
                <Grid container spacing={2} marginTop={1}>
                  <Grid item xl={6} sm={12} md={6}>
                    ...
                    >
                      ...
                      <CardContent>
                        <Typography>
                          The proportions of your diamond play a significant
                          role in its overall appearance and brilliance. This
                          includes:
                        </Typography>
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                        ...
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                          <span style={{ fontWeight: "bold" }}>Girdle:</span>{" "}
                          The thickness of the diamond's girdle (e.g., thin,
                          medium).
                        </Typography>
                        <Typography>
                          <FiberManualRecordIcon sx={{ fontSize: "small" }} />{" "}
                    ...
                    >
                      ...
                      <CardContent>
                        <Typography>
                          ...
                          provide detailed diagrams showing the diamond’s
                          internal and external features, ensuring you know
                          exactly what makes your diamond special.
                        </Typography>
                      </CardContent>
                    </Card>
                  </Grid>

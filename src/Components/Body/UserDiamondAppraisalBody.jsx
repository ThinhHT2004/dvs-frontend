...
const UserDiamondAppraisalBody = () => {
  ...
  function fetchService() {
    axios
      .get("http://localhost:8080/api/services/" + service)
      .then((response) => {
  ...
  const submitRequest = () => {
    axios
      .post("http://localhost:8080/api/request/create", request)
        ...
        <p style={{ textAlign: "center" }}>
          ...
          <span>
            <Link
              ...
              underline="none"
              sx={{ color: "#69CEE2", textDecoration: "underline" }}
            >
              Sign in
            </Link>
          </span>{" "}
              ...
              >
                <Select
                  ...
                  renderValue={(selected) => {
                    if (selected === "") {
                      return (
                        <em style={{ color: "#989898", fontStyle: "normal" }}>
                          Select Type of Appraisal
                        </em>
                      );
                    }
                    return services.find((option) => option.id === selected)
                      ?.name;
                  }}
                  sx={{
                    "& .MuiSelect-select": {
